...
let colors_name = "tomya"

hi Normal ctermbg=0 ctermfg=7 cterm=none guibg=#212221 guifg=#dcdccc gui=none
...
hi Folded guibg=#2D2E2D guifg=#c2b680 gui=none
hi IncSearch guibg=#866a4f guifg=fg gui=none
hi LineNr guibg=bg guifg=#515751 gui=none
...
hi SpecialKey guibg=bg guifg=#ffffff gui=none
if has("spell")
...
hi Comment guibg=#4A4A50 guifg=#c2b680 gui=none
hi Constant guibg=bg guifg=#afe091 gui=none
hi Error guibg=bg guifg=#f07070 gui=none
hi Identifier guibg=bg guifg=#E6BA91 gui=none
...
hi Special guibg=bg guifg=#ffffff gui=none
hi Statement guibg=bg guifg=#FAF882 gui=bold " This works for the $ in PHP
